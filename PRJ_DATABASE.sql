...
VALUES 
(1, 'user1', '1', 'user1@example.com', 'Nguyễn Văn A', 'User', GETDATE()),
(2, 'user2', '2', 'user2@example.com', 'Trần Thị B', 'Manager', GETDATE()),
(3, 'user3', '3', 'user3@example.com', 'Lê Văn C', 'User', GETDATE()),
(4, 'user4', '4', 'user4@example.com', 'Phạm Thị D', 'User', GETDATE()),
(5, 'user5', '5', 'user5@example.com', 'Hoàng Văn E', 'Manager', GETDATE());

-- Thêm dữ liệu vào bảng Services
INSERT INTO Services (ServiceID, ServiceName, ServiceDescription, Price)
VALUES 
(1, 'Internet', 'Cung cấp kết nối internet tốc độ cao', 100.00),
(2, 'Dọn phòng', 'Dịch vụ dọn phòng hàng tuần', 50.00),
(3, 'Giặt ủi', 'Dịch vụ giặt quần áo', 30.00),
(4, 'Gửi xe', 'Dịch vụ giữ xe tháng', 20.00),
(5, 'Điện', 'Chi phí sử dụng điện hàng tháng', 200.00);
...
VALUES 
(1, 'KTX A', 1, '123 Đường A, Ha Noi', 10, 500.00),
(2, 'KTX B', 2, '456 Đường B, Ha Noi', 8, 600.00),
(3, 'KTX C', 3, '789 Đường C, Ha Noi', 5, 700.00),
(4, 'KTX D', 4, '101 Đường D, Ha Noi', 3, 800.00),
(5, 'KTX E', 5, '202 Đường E, Ha Noi', 2, 900.00);

-- Thêm dữ liệu vào bảng Rooms
INSERT INTO Rooms (RoomID, DepartmentID, RoomNumber)
VALUES 
(1, 1, '101A'),
(2, 1, '102A'),
(3, 2, '201B'),
