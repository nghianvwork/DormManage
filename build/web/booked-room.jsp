...
<html>
    <head>
        ...
        <style>
            body {
                background-image: linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("img/R.jpg");
            ...
            .contact-buttons .zalo {
                background-color: #0084ff;
            }
            .contact-buttons .facebook {
                background-color: #4267B2;
            }
            .contact-buttons .hotline {
        ...
        <div class="container mt-4">
            ...
            <div class="row">
                <div class="container mt-5">
                    <h2 style=" margin-top: -35px;margin-bottom: 25px;">RENTED</h2>
