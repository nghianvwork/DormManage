 ...
 * @author admin
 */
@WebServlet(name="ConfirmPayment", urlPatterns={"/confirm-payment"})
public class ConfirmPayment extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (billIdParam != null) {
            ...
            boolean success = billDAO.confirmPaymentByAdmin(billID, true);
            
            if (success) {
                response.sendRedirect("payment-history");
            } else {
                response.getWriter().write("Failed to confirm payment.");
            }
        }
    }
